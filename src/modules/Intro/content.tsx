...
const content = {
  header: 'Russell Dias',
  description:
    "Senior product and engineering professional with 6+ years of experience. Currently, a full-stack engineering lead at YLabs. I'm also a serial tech founder who has built 3 startups. Previously, I've also worked on product strategy, launches, and development for leading companies.",
  roles: [
    {
      title: 'Tech Founder',
